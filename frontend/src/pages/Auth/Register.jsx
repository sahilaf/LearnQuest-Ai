...
export default function Register() {
  ...
  const { register, loginWithGoogle, isAuthenticated, devMode, error: authError, clearError } = useAuth();
        ...
        <Card className="shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-line-strong px-3 py-2 text-sm transition-colors"
                value={password}
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-surface px-2 text-muted">Or sign up with</span>
            </div>
          </div>
          ...
          <p className="mt-6 text-center text-sm text-body">
            ...
            <Link
              to="/login"
              className="font-semibold text-primary-300 hover:text-primary-300"
            >
              Sign in
            </Link>
          </p>
